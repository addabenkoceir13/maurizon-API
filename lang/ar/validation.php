...
return [
    ...
    */
    ...
    'required_without'     => 'الخانة :attribute إلزامية.',
    //'required_without_all' => 'الخانة :attribute إلزامية إذا لم يتوفّر أياً من :values.',
    'required_without_all' => 'الخانة :attribute إلزامية.',
    ...
    'gt' => [
      ...
      'array' => 'الخانة :attribute يجب أن تكون أكثر من :value عنصر.',

      'file' => 'الخانة :attribute يجب أن تكون أكبر من :value كيلوبايت.',

      'numeric' => 'الخانة :attribute يجب أن تكون أكبر من :value.',

      'string' => 'الخانة :attribute يجب أن تكون أكبر من :value أحرف.',

  ],

  'gte' => [

    'array' => 'الخانة :attribute يجب أن تكون أكثر من أو تساوي :value عنصر.',

    'file' => 'الخانة :attribute يجب أن تكون أكبر من أو تساوي :value كيلوبايت.',

    'numeric' => 'الخانة :attribute يجب أن تكون أكبر من أو تساوي :value.',

    'string' => 'الخانة :attribute يجب أن تكون أكبر من أو تساوي :value أحرف.',
