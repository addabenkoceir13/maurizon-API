        ...
        <form class="form-horizontal" onsubmit="event.preventDefault()" action="#"
          ...
          <div class="card-body">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
              <div hidden><img src="{{ asset('assets/img/icons/ad-not-found.jpg') }}"  alt="image" class="d-block rounded" height="120" width="500" id="old-image"/> </div>
              <img src="{{ asset('assets/img/icons/ad-not-found.jpg') }}" alt="image" class="d-block rounded" height="120" width="500" id="uploaded-image" />
            </div>
...
<script>
  $(document).ready(function(){
    ...
    $('#create').on('click', function() {
      ...
      document.getElementById('uploaded-image').src = "{{ asset('assets/img/icons/ad-not-found.jpg') }}" ;
      document.getElementById('old-image').src = "{{ asset('assets/img/icons/ad-not-found.jpg') }}" ;
      $("#modal").modal('show');
    });
      ...
      $.ajax({
          ...
          success:function(response){
              if(response.status==1){
                ...
                "{{ asset('assets/img/icons/ad-not-found.jpg') }}" : response.data.image;
